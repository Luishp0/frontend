...
const BarraLateral = () => {
  ...
  return (
    <div className={`flex flex-col justify-between ${sidebarOpen ? 'w-64' : 'w-16'} transition-all duration-300 relative ${darkMode ? 'bg-gray-900 text-white border-gray-700' : 'bg-white text-gray-600 border-gray-300'}`}>
      ...
      <ul className={`flex-1 space-y-2 relative ${dropdownOpen ? 'pb-24' : ''}`}>
