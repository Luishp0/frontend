...
export default function Example() {
  return (
    <div className="relative isolate overflow-hidden bg-gray-900 py-16 sm:py-24 lg:py-32 mt-8 mb-0" style={{ marginTop: '3cm' }}>
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          <div className="max-w-xl lg:max-w-lg">
            ...
            <p className="mt-4 text-lg leading-8 text-gray-300">
             Gracias a nuestra suscripción tendras notificaciones cuando tengamos nuevas actualizaciones
            </p>
          ...
          <dl className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
            ...
            <div className="flex flex-col items-start">
              ...
              <dd className="mt-2 leading-7 text-gray-400">
                El mensaje que se enviara no contara con spam alguno.
              </dd>
            </div>
          </dl>
        </div>
