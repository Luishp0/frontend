...
const product = {
  ...
  description:
    'Sumérgete en el mundo de la acuariofilia moderna con nuestra pecera inteligente, el complemento perfecto para tu hogar u oficina. Diseñada con tecnología de vanguardia y un estilo elegante, nuestra pecera inteligente ofrece una experiencia única tanto para los entusiastas de los peces como para aquellos que buscan un toque de sofisticación en su espacio.',
  highlights: [
    'Monitoreo Integral del Agua',
