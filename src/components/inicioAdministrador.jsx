...
const InicioAdministrador = () => {
    return (
        <div className="flex h-screen overflow-auto bg-gray-100"> {/* Cambiado overflow-hidden a overflow-auto */}
    <BarraLateral />
    <div className="flex flex-col flex-grow p-4">
        ...
        <div className="flex flex-col gap-4" style={{ marginTop: '1px' }}> {/* Añadido margen superior */}
            <div className="flex flex-wrap gap-4 mb-4">
                <div className="flex-1 min-w-[200px] bg-white rounded-lg shadow-md overflow-hidden">
                    <GraficaBarras />
                </div>
                <div className="flex-1 min-w-[200px] bg-white rounded-lg shadow-md overflow-hidden">
                    <GraficaPastel />
