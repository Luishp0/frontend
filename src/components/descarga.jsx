    ...
    <section className="text-gray-600 dark:text-gray-400 body-font">
      <div className="container px-5 py-24 mx-auto flex items-center md:flex-row flex-col">
        ...
        <div className="flex md:ml-auto md:mr-0 mx-auto items-center flex-shrink-0 space-x-4">
          ...
          <button className="bg-gray-100 dark:bg-gray-900 inline-flex py-3 px-5 rounded-lg items-center hover:bg-gray-200 dark:hover:bg-gray-700 focus:outline-none transition-colors duration-300">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-6 h-6 text-gray-800 dark:text-gray-300" viewBox="0 0 305 305">
            ...
            <span className="ml-4 flex items-start flex-col leading-none">
              <span className="text-xs text-gray-600 dark:text-gray-100 mb-1">Descargar en el</span>
              <span className="title-font font-medium text-gray-900 dark:text-gray-100">App Store</span>
            </span>
          </button>
        </div>
      </div>
